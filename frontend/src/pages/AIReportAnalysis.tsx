    ...
    <main className="mx-auto max-w-5xl space-y-6 px-4 py-8">
      ...
      {analysis && (
        <>
          ...
          {analysis.explanation && <section className="gov-panel p-6"><h2 className="text-lg font-semibold text-slate-900">Why this result?</h2><p className="mt-2 text-sm leading-6 text-slate-700">{analysis.explanation}</p></section>}
        </>
      )}
    </main>
  );
