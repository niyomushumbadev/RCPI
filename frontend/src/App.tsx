...
const CreateReport = lazy(() => import('./pages/citizen/CreateReport'));
const MyReports = lazy(() => import('./pages/citizen/MyReports'));
const ReportDetail = lazy(() => import('./pages/citizen/ReportDetails'));
const Profile = lazy(() => import('./pages/citizen/Profile'));
const Notifications = lazy(() => import('./pages/citizen/Notifications'));
const HelpPage = lazy(() => import('./pages/citizen/Help'));
...
const GovernmentAIDashboard = lazy(() => import('./pages/intelligence/GovernmentAIDashboard'));
const AIReportAnalysis = lazy(() => import('./pages/intelligence/AIReportAnalysis'));
...
export default function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        {/* Fallback covers lazy page chunks while they load */}
